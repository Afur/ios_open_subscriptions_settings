...
class IosOpenSubscriptionsSettings {
  ...
  static const MethodChannel _channel =
      MethodChannel('ios_open_subscriptions_settings');

  /// Opening subscriptions settings
  static Future<void> openSubscriptionsSettings(
  ...
  static Future<void> initiateRefundRequest({
    required String transactionId,
  }) async {
    _channel.invokeMethod('initiateRefundRequest', {
